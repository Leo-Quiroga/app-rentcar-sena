...
//   return (
//     <div className="space-y-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-5">
//       {/* Hero + SearchBar */}
//       <section>
...
//               key={car.id}
//               car={car}
//               onDetail={(c) => setSelectedCar(c)}        // abre ModalCarDetail
//               onReserve={(c) => {
//                 // handler centralizado: sólo abrir si condiciones se cumplen (extra check)
...
//           onReserve={(car) => {
//             // si desde el modal detalle se pulsa "Reservar", abrimos confirmar reserva
//             setCarToReserve(car);
//             setSelectedCar(null);
//           }}
//         />
